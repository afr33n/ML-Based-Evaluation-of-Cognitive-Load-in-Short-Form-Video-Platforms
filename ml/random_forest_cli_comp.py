...
def validate_against_cli(merged: pd.DataFrame) -> None:
    ...
    with open(METRICS_FILE, "w") as f:
        f.write("Random Forest vs CLI Validation\n")
        f.write("===============================\n\n")
    ...
    plt.xlabel("CLI")
    plt.ylabel("Random Forest ML Risk Score")
    plt.title("CLI vs Random Forest ML Risk Score")
    plt.tight_layout()
    ...
    plt.ylabel("CLI")
    plt.title("CLI Distribution by Random Forest Predicted Label")
    plt.tight_layout()
